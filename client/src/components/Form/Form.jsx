...
const Form = () => {
    ...
    const formCompletedHandler = () => {
        if (form.name !== "" && form.difficulty !== 0 && form.duration !== 0 && form.season !== "" && form.country !== "" && form.description !== "") return true;
    ...
    return (
        <form onSubmit={handleSubmit}>
            ...
            <br />
                ...
                <hr />
            <button disabled={!formCompletedHandler()} type= "submit">Aceptar</button>
            <Link to="/home">
